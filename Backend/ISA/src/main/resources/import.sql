...
INSERT INTO clinics (name, address, city, country, description, rating_average) 
VALUES ('Clinic 1', 'Address 1', 'Novi Sad', 'Serbia', 'This is clinic 1 description.', 1);

INSERT INTO clinics (name, address, city, country, description, rating_average) 
VALUES ('Clinic 2', 'Address 2', 'Novi Sad', 'Serbia', 'This is clinic 2 description.', 1);

INSERT INTO clinics (name, address, city, country, description, rating_average) 
VALUES ('Clinic 3', 'Address 3', 'Podgorica', 'Montenegro', 'This is clinic 3 description.', 1);
...
INSERT INTO registrations (id, approved, activated)
VALUES (5, true, true);
INSERT INTO users (email, password, first_name, last_name, address, city, country, phone, role_id, registration_id, clinic_id, appointmenttype_id, work_start, work_end, rating_average)
VALUES ('doctor1@g.com', '$2a$10$GGi3fzEAMIAgQE/lsADrueJsbTGbCYezOB/dAuXtMSUfkduNgTxX6', 'Doctor1 first', 'Doctor1 last', 'Doctor address', 'Doctor city', 'Doctor country', '0631231231', 2, 5, 1, 1, 8, 16, 1);

INSERT INTO registrations (id, approved, activated)
VALUES (6, true, true);
INSERT INTO users (email, password, first_name, last_name, address, city, country, phone, role_id, registration_id, clinic_id, appointmenttype_id, work_start, work_end, rating_average)
VALUES ('doctor2@g.com', '$2a$10$GGi3fzEAMIAgQE/lsADrueJsbTGbCYezOB/dAuXtMSUfkduNgTxX6', 'Doctor2 first', 'Doctor2 last', 'Doctor address', 'Doctor city', 'Doctor country', '0631231231', 2, 6, 1, 2, 8, 16, 1);
...
INSERT INTO appointments (time, type_id, clinic_id, price_id, room_id, doctor_id, patient_id, approved, predefined, requested, patient_approved) 
VALUES ('2020-3-24 12:00:00', 1, 1, 1, 1, 5, NULL, false, true, false, false);

INSERT INTO appointments (time, type_id, clinic_id, price_id, room_id, doctor_id, patient_id, approved, predefined, requested, patient_approved) 
VALUES ('2020-3-24 09:30:00', 2, 1, 2, 2, 6, NULL, false, true, false, false);

INSERT INTO appointments (time, type_id, clinic_id, price_id, room_id, doctor_id, patient_id, approved, predefined, requested, patient_approved) 
VALUES ('2020-3-24 12:30:00', 2, 2, 4, 3, 7, NULL, false, true, false, false);
